...
import com.example.tugaspm3.model.Anjing;
import com.example.tugaspm3.model.Hewan;
import com.example.tugaspm3.model.Itik;
import com.example.tugaspm3.model.Kucing;
...
public class DataProvider {
    ...
    private static List<Itik> initDataItik(Context ctx) {
        ...
        itiks.add(new Itik("Melewar", "Tegal",
                "bentuk badan yang mirip botol, langsing, postur tubuhnya tegak, tinggi badannya dapat mencapai 50 cm.", R.drawable.itik_melewar));
        itiks.add(new Itik("perut hitam", "Jawa timur ",
                "bentuk badan yang mirip botol, langsing, postur tubuhnya tegak, tinggi badannya dapat mencapai 50 cm.", R.drawable.itik_peruthitam));
        itiks.add(new Itik("polos", "Indonesia",
                "Ras itik asli pulau Bali ", R.drawable.itik_polos));
        itiks.add(new Itik("ternak", "jember",
                "itik yang berasal dari jember yang awalnya biasa digunakan untuk menjaga ternak oleh suku Samoyed", R.drawable.itik_ternak));
        itiks.add(new Itik("alabio", "Jeruk manis",
                "itik pintar dan kuat, sekarang banyak digunakan sebagaiitik penjaga, pengawal, dan itik warga (K9)", R.drawable.itik_alabio));
        itiks.add(new Itik("totol", "lombok",
                "itik dari daerah Shiba ini gesit dan lincah sehingga awalnya banyak digunakan untuk berburu ", R.drawable.itik_totol));
        return itiks;
    }
